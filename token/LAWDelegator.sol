...
import "./LAWDelegate.sol";

contract LAWDelegator is LAWTokenInterface, LAWDelegatorInterface {
    /**
     * @notice Construct a new LAW
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "LAWDelegator::_setImplementation: Caller must be gov");
    ...
    function() external payable {
        require(msg.value == 0, "LAWDelegator:fallback: cannot send value to fallback");
